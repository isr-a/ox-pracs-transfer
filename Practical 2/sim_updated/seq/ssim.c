 ...
 ***********************************************************************/
 ...
 /***********************************************************************
  *
  * Modified to compile with TCL8.6 by removing direct access to Results
  * previously implemented as interp->results.
  *
  ***********************************************************************/
...
/* Hack for SunOS */
/* Commented out to prevent build not working in Room 379 */
//extern int matherr();
